...
@WebServlet("/favorites/action")
public class FavoritesActionServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        if (currentUser == null) {
            out.print("{\"success\": false, \"message\": \"Please log in to manage your favorites\"}");
            return;
        }
        ...
        try {
            ...
            if (favoritesDao == null) {
                out.print("{\"success\": false, \"message\": \"Favorites service unavailable\"}");
                return;
            }
            ...
            if ("add".equals(action)) {
                success = favoritesDao.addMovieToFavorites(currentUser.getId(), movieId);
                message = success ? "Added to favorites" : "Failed to add to favorites";
            } else if ("remove".equals(action)) {
                success = favoritesDao.removeMovieFromFavorites(currentUser.getId(), movieId);
